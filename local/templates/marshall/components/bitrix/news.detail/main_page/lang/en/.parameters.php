...
$MESS["T_IBLOCK_DESC_IS_EXPLORE_BUTTON"] = "Show the EXPLORE button";
$MESS["T_IBLOCK_DESC_EXPLORE_BUTTON_TEXT"] = "The text of the EXPLORE button";
$MESS["T_IBLOCK_DESC_EXPLORE_BUTTON_LINK"] = "The link of the EXPLORE button";
?>